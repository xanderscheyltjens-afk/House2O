...
Note: SMARTS is a clear-sky model. Cloud cover is not accounted for.
"""
...
#---- Define the SMARTS function wrapper since it seems locked in the class-------------------
